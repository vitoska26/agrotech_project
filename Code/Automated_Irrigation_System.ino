...
void loop() {
  ...
  //soil sensors analog readings
  int sensorVal35 = analogRead(35);
  int sensorVal32 = analogRead(32);
  //SH - Soil Moisture (accidently named 'humidity')
  int SH35 = map(sensorVal35, wet35, dry35, 100, 0);//fixed function to convert analog readings into moisture % 
